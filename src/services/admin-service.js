...
class ReportService {
    ...
    generateHTMLReport(title, subtitle, columns, data) {
        ...
        return `
            ...
            <body>
                <div class="header">
                    <div class="logo">BAPS Swaminarayan Chhatralay</div>
                    <h1>${title}</h1>
                    <p>${subtitle}</p>
                </div>
                <div class="meta">
                ...
                <div class="footer">
                    ...
                    <p>BAPS APC Management System | Official Record</p>
                </div>
...
window.BapsAdmin = new class {
    ...
    generateAndDownloadRequest(form) {
        ...
        const content = `
            ...
            <body>
                <div class="header">
                    <div class="logo-text">BAPS Swaminarayan Chhatralay</div>
                ...
                <div class="signature-block">
                    ...
                    <div class="contact">BAPS Swaminarayan Chhatralay</div>
                </div>

                <div class="footer">
                    This document is officially generated by the BAPS APC Management Portal.<br>
    ...
    generateGatepassDocument(passData) {
        ...
        const html = `
            ...
            <body>
                ...
                <div class="header">
                    <div style="font-size: 16px; font-weight: bold;">BAPS SWAMINARAYAN CHHATRALAY, VALLABH VIDYANAGAR</div>
